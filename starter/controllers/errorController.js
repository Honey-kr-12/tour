...
const handleDuplicateFieldDB = err => {
    ...
    const message = `Duplicate field value  ${value} please try another name`;
    return new AppError(message,400);
}
...
const handleJWTExpiredError = () => new AppError('your token has beeen expired, please login again',401);
